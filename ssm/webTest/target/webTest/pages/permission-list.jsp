	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
									...
									<c:forEach items="${pageInfo.list}" var="permission">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/user/findUserByIdAndAllRole?id=${permission.id}" class="btn bg-olive btn-xs">添加权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
						...
						<div class="pull-left">
							<div class="form-group form-inline">
								...
								<select class="form-control" id="changePageSize" onchange="changePageSize()">
									<option ${pageInfo.pageSize==1?"selected='selected'":""}>1</option>
									<option ${pageInfo.pageSize==2?"selected='selected'":""}>2</option>
									<option ${pageInfo.pageSize==3?"selected='selected'":""}>3</option>
									<option ${pageInfo.pageSize==4?"selected='selected'":""}>4</option>
									<option ${pageInfo.pageSize==5?"selected='selected'":""}>5</option>
								</select> 条
							</div>
						</div>
			...
			<strong>Copyright &copy; 2014-2017 <a
				href="https://www.zhku.edu.cn/">研究院研发部</a>.
